...
package sifive.fpgashells.shell.xilinx.xcvu440shell
...
import sifive.fpgashells.ip.xilinx.{IBUFDS, PowerOnResetFPGAOnly, sdio_spi_bridge, xcvu440_sys_clock_mmcm0,
                                    xcvu440_sys_clock_mmcm1, xcvu440reset}

//-------------------------------------------------------------------------
// XCVU440Shell
//-------------------------------------------------------------------------

trait HasDDR3 { this: XCVU440Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val ddr = IO(new XilinxXCVU440MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxXCVU440MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxxcvu440mig.c0_sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxxcvu440mig.c0_ddr3_ui_clk
    mig_sys_reset                := dut.xilinxxcvu440mig.c0_ddr3_ui_clk_sync_rst
    dut.xilinxxcvu440mig.c0_ddr3_aresetn   := mig_resetn
    dut.xilinxxcvu440mig.sys_rst   := sys_reset

    ddr <> dut.xilinxxcvu440mig
  }
}

abstract class XCVU440Shell(implicit val p: Parameters) extends RawModule {
  ...
  //25MHz and multiples
  val xcvu440_sys_clock_mmcm0 = Module(new xcvu440_sys_clock_mmcm0)
  xcvu440_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  xcvu440_sys_clock_mmcm0.io.reset   := reset
  val clk12_5              = xcvu440_sys_clock_mmcm0.io.clk_out1
  val clk25                = xcvu440_sys_clock_mmcm0.io.clk_out2
  val clk37_5              = xcvu440_sys_clock_mmcm0.io.clk_out3
  val clk50                = xcvu440_sys_clock_mmcm0.io.clk_out4
  val clk100               = xcvu440_sys_clock_mmcm0.io.clk_out5
  val clk150               = xcvu440_sys_clock_mmcm0.io.clk_out6
  val clk75                = xcvu440_sys_clock_mmcm0.io.clk_out7
  val xcvu440_sys_clock_mmcm0_locked = xcvu440_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  val xcvu440_sys_clock_mmcm1 = Module(new xcvu440_sys_clock_mmcm1)
  xcvu440_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  xcvu440_sys_clock_mmcm1.io.reset   := reset
  val clk32_5              = xcvu440_sys_clock_mmcm1.io.clk_out1
  val clk65                = xcvu440_sys_clock_mmcm1.io.clk_out2
  val xcvu440_sys_clock_mmcm1_locked = xcvu440_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !xcvu440_sys_clock_mmcm0_locked ||
                          !xcvu440_sys_clock_mmcm1_locked
  ...
  val safe_reset = Module(new xcvu440reset)
