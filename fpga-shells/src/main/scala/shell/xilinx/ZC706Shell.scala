...
package sifive.fpgashells.shell.xilinx.zc706shell
...
import sifive.fpgashells.ip.xilinx.{IBUFDS, PowerOnResetFPGAOnly, sdio_spi_bridge, zc706_sys_clock_mmcm0,
                                    zc706_sys_clock_mmcm1, zc706reset}

//-------------------------------------------------------------------------
// ZC706Shell
//-------------------------------------------------------------------------

trait HasDDR3 { this: ZC706Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val ddr = IO(new XilinxZC706MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxZC706MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxzc706mig.sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxzc706mig.ui_clk
    mig_sys_reset                := dut.xilinxzc706mig.ui_clk_sync_rst
    mig_mmcm_locked              := dut.xilinxzc706mig.mmcm_locked
    dut.xilinxzc706mig.aresetn   := mig_resetn
    dut.xilinxzc706mig.sys_rst   := sys_reset

    ddr <> dut.xilinxzc706mig
  }
}

abstract class ZC706Shell(implicit val p: Parameters) extends RawModule {
  ...
  //25MHz and multiples
  val zc706_sys_clock_mmcm0 = Module(new zc706_sys_clock_mmcm0)
  zc706_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  zc706_sys_clock_mmcm0.io.reset   := reset
  val clk12_5              = zc706_sys_clock_mmcm0.io.clk_out1
  val clk25                = zc706_sys_clock_mmcm0.io.clk_out2
  val clk37_5              = zc706_sys_clock_mmcm0.io.clk_out3
  val clk50                = zc706_sys_clock_mmcm0.io.clk_out4
  val clk100               = zc706_sys_clock_mmcm0.io.clk_out5
  val clk150               = zc706_sys_clock_mmcm0.io.clk_out6
  val clk75                = zc706_sys_clock_mmcm0.io.clk_out7
  val zc706_sys_clock_mmcm0_locked = zc706_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  val zc706_sys_clock_mmcm1 = Module(new zc706_sys_clock_mmcm1)
  zc706_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  zc706_sys_clock_mmcm1.io.reset   := reset
  val clk32_5              = zc706_sys_clock_mmcm1.io.clk_out1
  val clk65                = zc706_sys_clock_mmcm1.io.clk_out2
  val zc706_sys_clock_mmcm1_locked = zc706_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !zc706_sys_clock_mmcm0_locked ||
                          !zc706_sys_clock_mmcm1_locked
  ...
  val safe_reset = Module(new zc706reset)
